...
БЮДЖЕТ ТЕКСТА: у тебя ~2000 слов на всё заключение. Распредели РАВНОМЕРНО:
- Секции 1-3: по ~250 слов (факты)
- Секции 4-6: по ~400 слов (аналитика)
НЕ ПРЕВЫШАЙ бюджет. Лучше быть кратким, чем не уложиться.
